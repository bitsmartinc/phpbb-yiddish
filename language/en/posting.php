...
$lang = array_merge($lang, array(
	...
	'BBCODE_B_HELP'				=> 'באלד טעקסט: [b]טעקסט[/b]',
	...
	'POST_GLOBAL'				=> 'Global',
	'POST_ICON'					=> 'טעמע אייקאן',
	'POST_NORMAL'				=> 'Normal',
	'POST_REVIEW'				=> 'תגובה איבערבליק',
	'POST_REVIEW_EDIT'			=> 'תגובה איבערבליק',
	...
	'POST_STORED'				=> 'די תגובה איז סוקסעספול געשיקט געווארן',
	'POST_STORED_MOD'			=> 'די תגובה איז סוקסעספול געשיקט געווארן אבער עס וועט דארפען באשטעטיגט ווערן דורך א מאָדעראַטאָר איידער עס ווערט געזען ברבים.',
